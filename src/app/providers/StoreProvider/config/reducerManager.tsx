import { combineReducers, UnknownAction, Reducer, ReducersMapObject } from "@reduxjs/toolkit"
import { StateSchema, StateSchemaKeys } from "../types/types"
import { ReducerManagerInterface } from "../types/types"

export function createReducerManager(initialReducers: ReducersMapObject<StateSchema>): ReducerManagerInterface {
