...
export const getArticlesSortField = (state: StateSchema) =>
    state.articles?.sort_field || ArticleSortFields.CREATED_AT;
export const getArticlesOrder = (state: StateSchema) =>
    state.articles?.sort_order || 'asc';
export const getArticlesSearchField = (state: StateSchema) =>
    state.articles?.search || '';
export const getArticlesTabs = (state: StateSchema) =>
    state.articles?.tabs || ArticleTabs.ALL;
