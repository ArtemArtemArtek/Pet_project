    ...
    if (articles_view === ArticlesView.BIG) {
        return (
            <div
                ...
                className={cls.article_big_card}>
                ...
                <div className={cls.sub_title}>
                    <div className={cls.types_wrapper}>
                        {article.type.map((el) => (
                            <div className={cls.type_item}>{el}</div>
                        ))}
                    </div>
                ...
                <div className={cls.fade_text}>
                    {
                        //@ts-ignore
                        article.blocks.find((el) => el.type === 'TEXT').paragraphs
                    }
                </div>
                <Button
                    data-testid="ArticleItemReadmoreButton"
                    onClick={redirectArticle}
                    className={cls.button_big_style}
            ...
            <div className={cls.sub_title}>
                <div className={cls.types_wrapper}>
                    {article.type.map((el) => (
                        <div
                            key={el}
                            data-testid={'ArticleItemType' + el}
                            className={cls.type_item}>
                            {el}
                        </div>
                    ))}
                </div>
