...
describe('ClassNamrHelper', () => {
    ...
    test('Default value with mode', () => {
        ...
        expect(ClassNameHelper('someClass', { scrolable: true }, [])).toBe(
            expected,
        );
    });
    test('Default value with attributes', () => {
        const expected = 'someClass some attribute';
        expect(ClassNameHelper('someClass', {}, ['some attribute'])).toBe(
            expected,
        );
    });
    test('Default value with mode and attributes', () => {
        ...
        expect(
            ClassNameHelper('someClass', { scrolable: true }, [
                'some attribute',
            ]),
        ).toBe(expected);
    });
    ...
    test('Default value with mods undefined', () => {
        ...
        expect(
            ClassNameHelper(
                'someClass',
                { scrolable: false, hideble: true, pointeble: undefined },
                [],
            ),
        ).toBe(expected);
    });
