...
const recomendationSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(fetchRecomendationData.fulfilled, (state, action: PayloadAction<ArticleDetailType[]>) => {
...
export const recomendationsSelectors = recomendationAdapter.getSelectors<StateSchema>(
  (state) => state.recomendation || recomendationAdapter.getInitialState()
)
