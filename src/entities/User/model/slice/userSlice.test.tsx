...
describe('userSlice test', () => {
    test('Set login', () => {
        expect(userReducer(testingState, userActions.setUserData(UserEntryData))).toEqual({
            isAuth: {
                id: 1,
                username: 'alan'
            }
    ...
    test('Logout', () => {
        expect(userReducer(testingState, userActions.logout())).toEqual({ isAuth: undefined })
    })
